...
func TestUser(t *testing.T) {
	t.Run("ValidUser", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)

		assertions.Nil(db.AutoMigrate(&User{}))

		u := RandomUser()
		assertions.Nil(db.Create(u).Error)
	}))
	t.Run("RepeatedUser", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
	...
	t.Run("Claims", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
	...
	t.Run("Authenticate-Fail", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
	...
	t.Run("BeforeSave-ValidUser", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
	...
	t.Run("BeforeSave-NoPassword", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
	...
	t.Run("Update - Password", database.Test(func(t *testing.T, db *gorm.DB) {
		assertions := assert.New(t)
